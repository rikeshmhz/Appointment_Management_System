...
import { getacceptappointment, updatestatus } from '../APi/Adminapi'
                ...
                <div className='my-8'>
                    {
                        loading ?
                            ...
                            :
                            <span className='text-3xl font-bold'>Accept Appointments</span>
                    }
                                                ...
                                                <>
                                                    <tr className="border-b bg-gray-800 border-gray-700">
                                                        ...
                                                        <td className="px-6 py-4">
                                                            <span className="font-medium cursor-pointer text-red-600 hover:underline" onClick={handleStatus(v._id,v.email,v.service_name,2)}>Reject</span>
                                                        </td>
                                                    </tr>
                                                    <tr className="hidden">
                                                        {
